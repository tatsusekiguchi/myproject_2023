...
$(document).ready(function () {
  ...
  if ($(".aboutMain").length) {
    $(".navList .about").addClass("current");
  }

  if ($(".nursingMain").length) {
    $(".navList .nursing").addClass("current");
  }

  if ($(".marineMain").length) {
    $(".navList .marine").addClass("current");
  }

  if ($(".recruitMain").length || $(".workingMain").length) {
    $(".navList .recruit").addClass("current");
  }

  if ($(".companyMain").length) {
    $(".navList .company").addClass("current");
  }
