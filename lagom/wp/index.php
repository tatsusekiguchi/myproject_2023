	...
	<main id="top">
		...
		<div class="section__concept" id="concept">
			<div class="section__concept__wrap">
				...
				<p class="fadeUp">家づくりの経験から、<br class="spBreak">「こんな家を建ててみたい」と<br>日ごろから考えていたアイデアや思いをカタチにした、<br class="spBreak">Lagomオリジナルの規格化住宅です。<br>「設計」「デザイン」「性能」「自然素材」が<br class="spBreak">すべて揃った居心地の良い空間を堪能ください。</p>
				<div class="section__concept__container">
					...
					<div class="section__concept__box">
						...
						<div class="txtBox fadeUp">
							<p>デザイン性の高い規格化住宅。<br>自由設計でもなく、建売でもない、<br>ちょうど良いプランオーダー住宅<br>そんな思いから「Lagom」は生まれました。</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="section__story" id="story">
			<div class="section__story__top">
				<div class="section__story__wrap fadeUp">
					...
					<p>素敵な理想〈デザイン性〉と<br class="spBreak">暮らしの現実〈生活・家事動線〉<br>どちらも兼ね備えた住まいを探している人に向けた<br>ちょうど良い規格化住宅をつくりたい。<br>多すぎず少なすぎず。すっと、ずっと。それが「Lagom」。</p>
				</div>
			</div>
					...
					<ol>
						...
						<li class="fadeUp">
							<dl>
								...
								<dd>
									<p>Lagomの世界観や示したい暮らし方・過ごし方を表現したモデルハウスへお越しください。<br>規格化住宅の良さとLagomが提案する間と余白を感じてください。</p>
								</dd>
							</dl>
						</li>
						<li class="fadeUp">
						...
						<li class="fadeUp">
							<dl>
								...
								<dd>
									<p>Lagomは規格化住宅です。思い通りの設計を行う注文住宅や決まりきった建売とは異なり、コンセプトに沿ったプランを選択していただき、理想の家を絞っていきます。</p>
								</dd>
							</dl>
						</li>
						<li class="fadeUp">
					...
					<div class="section__contact__top__box">
						<dl class="line">
							...
							<dd>
								...
								<div class="btn line"><a href="" target="_blank" rel="noopener"><span>公式LINE</span></a></div>
							</dd>
						</dl>
						<dl class="tel">
							<dt>お電話でのお問い合わせ</dt>
