...
function ReLayout() {
  ...
  if (_width >= 1025) {
    //幅に応じて読み込む画像を変更する
    changeImg(".switch");
    $(".campaignSection .message p").html(
      "詳しくはスタッフまで<br>お問い合わせ下さい♪"
    );
  } else {
    changeImg(".switch");
    $(".campaignSection .message p").html(
      "詳しくは0299-83-5298までお問い合わせください"
    );
  }
}
...
$(document).ready(function () {
  ...
  if ($(".swiperContainer").length > 0) {
    var topManuSlide = new Swiper(".swiperContainer", {
...
function pageScroll() {
  $(".linkList .li[data-target],.linkBtn[data-target]").on(
    ...
    function (e) {
      e.preventDefault();
      var headH = $(".header .headWrap").innerHeight();
...
function setHeaderFixed() {
  ...
  $(window).scroll(function () {
    ...
    scroll = $(".header .headWrap").innerHeight();
