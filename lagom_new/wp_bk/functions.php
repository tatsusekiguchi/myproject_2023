...
// -------------------------------------------------------------------
// 管理画面の「投稿」を「イベント・新着情報」に変更
// -------------------------------------------------------------------
function change_post_menu_label() {
	global $menu;
	global $submenu;
	$menu[5][0] = 'イベント・新着情報';
	$submenu['edit.php'][5][0] = 'イベント・新着情報一覧';
	$submenu['edit.php'][10][0] = '新しいイベント・新着情報';
	$submenu['edit.php'][16][0] = 'タグ';
}
function change_post_object_label() {
	global $wp_post_types;
	$labels = &$wp_post_types['post']->labels;
	$labels->name = 'イベント・新着情報';
	$labels->singular_name = 'イベント・新着情報';
	$labels->add_new = _x('追加', 'イベント・新着情報');
	$labels->add_new_item = 'イベント・新着情報の新規追加';
	$labels->edit_item = 'イベント・新着情報の編集';
	$labels->new_item = '新規イベント・新着情報';
	$labels->view_item = 'イベント・新着情報を表示';
	$labels->search_items = 'イベント・新着情報を検索';
