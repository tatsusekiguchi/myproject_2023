...
$(document).ready(function () {
  ...
  if ($(".caseMain .postDetail .slickSlide").length > 0) {
    //上部画像の設定
    $(".caseMain .postDetail .thumb-item").slick({
    ...
    //選択画像の設定
    $(".caseMain .postDetail .thumb-item-nav").slick({
      infinite: true, //スライドをループさせるかどうか。初期値はtrue。
...
//======================================================================================================
function setAccord() {
  $(".accordPanel .accordBody").hide();
  $(".accordPanel .accordHead").click(function () {
