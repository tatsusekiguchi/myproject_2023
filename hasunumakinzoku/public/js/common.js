...
$(document).ready(function () {
  ...
  scrollAnim(".pageScrollLink a");

  $(".topMain .sec02.businessContainer").hover(
    function () {
      $(".businessSection").addClass("hover-sash");
    },
    function () {
      $(".businessSection").removeClass("hover-sash");
    }
  );

  $(".topMain .sec03.businessContainer").hover(
    function () {
      $(".businessSection").addClass("hover-metalwork");
    },
    function () {
      $(".businessSection").removeClass("hover-metalwork");
    }
  );
  if ($(".atomsSlider").length > 0) {
    $(".atomsSlider").slick({
      autoplay: true,
      fade: false,
      slidesToShow: 3,
  ...
  if ($(".worksMain .worksPanel--detail").length > 0) {
