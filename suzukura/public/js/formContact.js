  ...
  if (formDataArr.length > 0) {
    ...
    formDataArr.map(function (item) {
      ...
      switch (item.name) {
        ...
        case "hour1":
          yearArr1["時頃"] = item.value ? item.value : "";
          var yearStr1 = "";
          for (key in yearArr1) {
            yearStr1 += yearArr1[key] + key;
          }
          formData.append("面談希望日時1", yearStr1);
          break;
        ...
        case "hour2":
          yearArr2["時頃"] = item.value ? item.value : "";
          var yearStr2 = "";
          for (key in yearArr2) {
            yearStr2 += yearArr2[key] + key;
          }
          formData.append("面談希望日時2", yearStr2);
          break;
        ...
        case "hour3":
          yearArr3["時頃"] = item.value ? item.value : "";
          var yearStr3 = "";
          for (key in yearArr3) {
            yearStr3 += yearArr3[key] + key;
          }
          formData.append("面談希望日時3", yearStr3);
          break;
