...
##サンクスページのURL
$config{"thanks_url"} = '../../thanks2.html';
...
##送信者に届く自動返信メールの件名
$config{"return_subject"} = '【内藤メディカルクリニック】初診・相談予約ありがとうございます。';
...
この度は初診・相談予約をいただきまして誠にありがとうございます。
