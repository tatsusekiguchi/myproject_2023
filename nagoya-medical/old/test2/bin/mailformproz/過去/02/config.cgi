...
# ひとつの場合 
#@mailto = ('naito-c@dolphin.ocn.ne.jp');
# 複数の場合 (シングルクォートでくくったメールアドレスをカンマで区切って指定)
@mailto = ('naito-c@dolphin.ocn.ne.jp','naito_medical_mail@ybb.ne.jp','doctornaito@gmail.com','doctor-kazu@joy.ocn.ne.jp');
