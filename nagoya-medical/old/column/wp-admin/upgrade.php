...
if($error){
$error_proc = "<ul><li>インストールディレクトリ/wp-admin/install.php を削除してください。</li>\n".                                                                                            "<li>インストールディレクトリ/wp-admin/upgrade.phpを削除してください。</li></ul>\n";
echo mb_convert_encoding('<strong>ファイルの削除に失敗しました。ご自身で次の作業を行ってください。</strong>'.$error_proc, "UTF-8", "auto");
}
