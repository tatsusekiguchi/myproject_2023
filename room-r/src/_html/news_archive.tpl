...
<!--{/php}-->
				<div class="category">
					<dl class="ovh">
						<dt>カテゴリ</dt>
						<dd><a href="<!--{$smarty.const.WEB_ROOT}-->/info/"<!--{php}-->if(isset($cat->errors)){ echo ' class="current"'; }<!--{/php}-->>すべて</a></dd>
						<dd class="ico_room"><a href="<!--{$smarty.const.WEB_ROOT}-->/info/category/room/" class="<!--{php}-->if(isset($cat->slug) && $cat->slug == "room"){ echo 'current'; }<!--{/php}-->">Room</a></dd>
						<dd class="ico_food"><a href="<!--{$smarty.const.WEB_ROOT}-->/info/category/food/" class="<!--{php}-->if(isset($cat->slug) && $cat->slug == "food"){ echo 'current'; }<!--{/php}-->">Food</a></dd>
						<dd class="ico_life"><a href="<!--{$smarty.const.WEB_ROOT}-->/info/category/life/" class="<!--{php}-->if(isset($cat->slug) && $cat->slug == "life"){ echo 'current'; }<!--{/php}-->">Life</a></dd>
						<dd class="ico_info"><a href="<!--{$smarty.const.WEB_ROOT}-->/info/category/info/" class="<!--{php}-->if(isset($cat->slug) && $cat->slug == "info"){ echo 'current'; }<!--{/php}-->">Info</a></dd>
					</dl>
				</div>
				<div class="article">
