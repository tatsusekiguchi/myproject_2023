<?php /* Smarty version 2.6.26, created on 2018-06-27 08:12:29
         compiled from footer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'footer.tpl', 84, false),)), $this); ?>
	<div id="footer">
		<div class="inner w980 mra mla">
			<div class="contact">
				<p>空室状況など、お気軽にお問合せください。</p>
				<div class="mt15"><img src="<?php echo @WEB_ROOT; ?>
/src/img/footer/tel.png" alt="TEL 052-990-7400" /></div>
...
/info/" class="tdu">新着ニュース</a></li>
			...
			<p class="mt30 fz12 lh200">
				...
				<?php 
						break;
					case 'store':
				 ?>愛知県名古屋市内のデザイナーズマンションの賃貸を専門に、賃貸物件情報をお届けするroomRroom(ルームRルーム)のスタッフが、名古屋で一人暮らしを始めたいあなたをサポートします。「ペットと暮らしたい」「安心して住みたい」「おしゃれに暮らしたい」など、お客様一人ひとりの理想のお部屋を叶えられるよう、選りすぐりのデザイナーズマンションをご紹介いたします。転勤や就職で名古屋に引っ越してきたばかりで、名古屋の賃貸事情が分からない方でも、名古屋の賃貸事情に精通したスタッフが新しい暮らしをサポートいたします。ぜひ名古屋市・伝馬町駅近くのアットホームな店舗にお越しください。
				<?php 
						break;
					case 'info':
