<?php /* Smarty version 2.6.26, created on 2018-02-24 17:53:19
         compiled from contact_complete.tpl */ ?>
...
/">HOME</a></span>
			...
			<h2 class="tac"><img src="src/img/contact/h_01.png" alt="お問合せ" /></h2>
			<div class="form mt25">
				<form action="contact.html<?php if (! empty ( $this->_tpl_vars['hid'] )): ?>?hid=<?php echo $this->_tpl_vars['hid']; ?>
<?php endif; ?>" method="post">
					<div class="inner">
						<div id="ct_1">
							<h3><img src="src/img/contact/progress_03.png" alt="完了" /></h3>
							<p class="fz14 fwb mt15">お問い合わせいただき、ありがとうございます。<br />メールの送信に成功しました。</p>
							<p class="mt10 fz12"><a href="<?php echo @WEB_ROOT; ?>
/" class="tdu">トップページへ戻る</a></p>
						</div><!-- #ct_1 -->
					</div><!-- .inner -->
				</form>
			</div><!-- .form -->
