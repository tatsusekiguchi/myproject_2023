<?php
    ...
    if ("" == mb_internal_encoding() || 'UTF-8' == mb_internal_encoding() || 'ISO-8859-1' == mb_internal_encoding()) {
        $jusho = (isset($_GET['ju'])) ? $_GET['ju'] : '';
    } else {
        $jusho = (isset($_GET['ju'])) ? mb_convert_encoding($_GET['ju'], 'UTF-8', mb_internal_encoding()) : '';
    }
	$jusho = (isset($_GET['ju'])) ? mb_convert_encoding($_GET['ju'], 'UTF-8', "auto") : '';
	if($jusho=="")
		$jusho = "愛知県名古屋市中区錦3";
