    ...
    formDataArr.map(function (item) {
      ...
      switch (item.name) {
        ...
        case "postal_02":
          ...
          break;
        case "address01":
          address01 = item.value ? "\n" + item.value : "";
          formData.append("住所", "〒" + postal01 + postal02 + address01);
          break;
        case "postal_03":
          postal03 = item.value ? item.value : "";
          break;
        case "postal_04":
          postal04 = item.value ? "-" + item.value : "";
          break;
        case "計画敷地住所":
          address02 = item.value ? "\n" + item.value : "";
          formData.append(
            "計画敷地住所",
            "〒" + postal03 + postal04 + address02
          );
          break;
        // 生年月日
        // ▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△▼△
