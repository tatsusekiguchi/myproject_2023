...
!function(t, i, e) {
    ...
    s.prototype = {
        ...
        _start: function(t) {
            ...
            if (this.enabled && (!this.initiated || h.eventType[t.type] === this.initiated)) {
                ...
                this.options.useTransition && this.isInTransition ? (this._transitionTime(), this.isInTransition = !1, s = this.getComputedPosition(), this._translate(e.round(s.x), e.round(s.y)), this._execEvent("scrollEnd")) : !this.options.useTransition && this.isAnimating && (this.isAnimating = !1, this._execEvent("scrollEnd")),
                this.startX = this.x,
                this.startY = this.y,
        ...
        _initEvents: function(i) {
            ...
            h.hasPointer && !this.options.disablePointer && (e(this.wrapper, h.prefixPointerEvent("pointerdown"), this), e(s, h.prefixPointerEvent("pointermove"), this), e(s, h.prefixPointerEvent("pointercancel"), this), e(s, h.prefixPointerEvent("pointerup"), this)),
    ...
    n.prototype = {
        ...
        updatePosition: function() {
            ...
            this.indicatorStyle.height = this.height + "px", i = this.maxPosY + this.indicatorHeight - this.height) : i = this.maxBoundaryY : "scale" == this.options.shrink && this.height != this.indicatorHeight && (this.height = this.indicatorHeight, this.indicatorStyle.height = this.height + "px")),
            this.x = t,
            this.y = i,
    ...
    e.fn.fp_scrolloverflow = function() {
        function s() {
            ...
            function n(i) {
                if (!i.hasClass("fp-noscroll")) {
                    ...
                    var d = e(t).height() - p;
                    s > d ? c.length ? n.update(i, d) : (a.options.verticalCentered ? i.find(g).wrapInner(r) : i.wrapInner(r), n.create(i, d, a.iscrollOptions)) : n.remove(i),
                    i.css("overflow", "")
                }
            }
            function r(t) {
        ...
        var S = {
            ...
            update: function(t, i) {
                ...
                //t.find(n).css("height", i + "px").parent().css("height", i + getPaddings(t) + "px")
                t.find(n).css("height", i + "px").parent().css("height", i + "px")
            },
            wrapContent: function() {
